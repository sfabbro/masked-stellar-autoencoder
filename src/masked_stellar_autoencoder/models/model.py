...
def quantile_loss(
    ...
    # ⚡ Bolt: Replace multiple-allocation torch.max with mathematically equivalent clamp_max expression to reduce intermediate tensor allocations and speed up execution.
