...
def quantile_loss(
    ...
    # ⚡ Bolt: Replace multiple-allocation torch.max calls with mathematically equivalent expressions to avoid allocating multiple large intermediate tensors and improve performance
