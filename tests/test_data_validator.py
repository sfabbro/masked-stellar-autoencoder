...
class TestDataValidator:
    ...
    def test_validate_stellar_data_high_nan(self):
        ...
        report = DataValidator.validate_stellar_data(data, feature_names, max_nan_fraction=0.5)
    ...
    def test_validate_stellar_data_multiple_issues(self):
        ...
        feature_names = ['G', 'BP_RP', 'parallax']
        report = DataValidator.validate_stellar_data(data, feature_names, max_nan_fraction=0.2)
        ...
        assert any("G magnitude values outside typical range" in w for w in warning_texts)
