...
try:
    ...
    # SECURITY FIX: Replaced os.system with safe subprocess call to prevent shell injection
...
def crossmatch_all(df_local):
    ...
    # SECURITY FIX: Replaced os.system with native Python shutil to prevent shell injection
